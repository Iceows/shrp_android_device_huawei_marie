...
# Assert
TARGET_OTA_ASSERT_DEVICE := marie,kirin710
...
BOARD_CUSTOM_BOOTIMG_MK := device/huawei/marie/custombootimg.mk
...
BOARD_SEPOLICY_DIRS += \
    device/huawei/marie/sepolicy

# ---------------------------------------------    
# SHRP-specific lines
# --------------------------------------------- 

SHRP_PATH := device/huawei/marie
SHRP_MAINTAINER := Iceows
SHRP_DEVICE_CODE := marie
